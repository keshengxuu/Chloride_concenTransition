...
The Python implementation of the chloride concentration–dependent model of seizure transitions was derived and modified from the model proposed by Jyun-you Liou et al. (eLife, 2020, 9:e50927). In addition, all simulation results were independently reproduced using MATLAB code.
...
The codes are provided for reference based on the work of Qianchen Gong, Yingpeng Liu, Yan Zhang, Muhua Zheng, and Kesheng Xu, Role of chloride concentration in modulating seizure transitions in excitatory and inhibitory networks, Physical Review E, DOI: https://doi.org/10.1103/x6qv-lzdg.
